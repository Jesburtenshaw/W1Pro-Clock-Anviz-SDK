    ...
    private void button_get_fp_raw_data_Click(object sender, EventArgs e)
        ...
        private void button31_Click(object sender, EventArgs e)
        {
            if (listViewDevice.SelectedItems.Count != 0)
            {
                ...
                Data.RecoradId[7] = (byte)((id_temp >> 56) & 0xff);
                Data.RecoradId[6] = (byte)((id_temp >> 48) & 0xff);
                Data.RecoradId[5] = (byte)((id_temp >> 40) & 0xff);
                Data.RecoradId[4] = (byte)((id_temp >> 32) & 0xff);
                Data.RecoradId[3] = (byte)((id_temp >> 24) & 0xff);
                Data.RecoradId[2] = (byte)((id_temp >> 16) & 0xff);
                Data.RecoradId[1] = (byte)((id_temp >> 8) & 0xff);
                Data.RecoradId[0] = (byte)((id_temp >> 0) & 0xff);
